...
`;function D(){return n.createElement(U,{href:"https://hang-man.org"},n.createElement("img",{src:"./static/images/logo-hangman.svg"}))}const U=s.ZP.a`
    margin-left: 25px;
    margin-top: 1px;
    img {
        height: 20px;
...
`,z={type:"night",colorsUI:{backgroundDark:"#404040",backgroundLight:"",backgroundAccent:"#9b9a9a",backgroundButton1:"#79a6e9db",backgroundButton2:"#20c997",textDark:"#363535",textLight:"#e0e0e0"},colorsGame:{backgroundNeutral:"#e7ebf1",backgroundLight:"#404040",backgroundGood:"#bbddb0",backgroundBad:"#c5a5b4"},bp:{mobileS:"max-width: 330px",mobileM:"max-width: 400px",mobileL:"max-width: 480px",tabletS:"max-width: 600px",tabletL:"max-width: 768px",desktopXS:"max-width: 900px",desktopS:"max-width: 1080px",desktopM:"max-width: 1200px",desktopL:"max-width: 1400px"}},j={type:"day",colorsUI:{backgroundDark:"#fff",backgroundLight:"#fff",backgroundAccent:"#d2e4ee",backgroundButton1:"#5277ae30",backgroundButton2:"#def0ea",textDark:"#000",textLight:"#000"},colorsGame:{backgroundNeutral:"#e7ebf1",backgroundLight:"#fff",backgroundGood:"#bbddb0",backgroundBad:"#c5a5b4"},bp:{mobileS:"max-width: 330px",mobileM:"max-width: 400px",mobileL:"max-width: 480px",tabletS:"max-width: 600px",tabletL:"max-width: 768px",desktopXS:"max-width: 900px",desktopS:"max-width: 1080px",desktopM:"max-width: 1200px",desktopL:"max-width: 1400px"}};function V(e){return new Promise(((t,r)=>{const a=new Image;a.onload=function(){t(a)},a.onerror=a.onabort=function(){r(e)},a.src=e}))}const X=["./static/images/1.png","./static/images/2.png","./static/images/3.png","./static/images/4.png","./static/images/5.png","./static/images/6.png","./static/images/7.png","./static/images/8.png"],K=(0,i.Pi)((()=>{!function(e){const[t,r]=(0,n.useState)(!1);(0,n.useEffect)((()=>{let t=!1;return async function(){if(t)return;const a=[];for(const t of e)a.push(V(t));await Promise.all(a),t||r(!0)}(),()=>{t=!0}}),[e])}(X);const e=L();return n.createElement(q,null,n.createElement("div",{className:"hangman__container"},(e=>{switch(e){case 8:default:return n.createElement(n.Fragment,null);case 7:return n.createElement("img",{className:"hangman",src:"./static/images/1.png"});case 6:return n.createElement("img",{className:"hangman",src:"./static/images/2.png"});case 5:return n.createElement("img",{className:"hangman",src:"./static/images/3.png"});case 4:return n.createElement("img",{className:"hangman",src:"./static/images/4.png"});case 3:return n.createElement("img",{className:"hangman",src:"./static/images/5.png"});case 2:return n.createElement("img",{className:"hangman",src:"./static/images/6.png"});case 1:return n.createElement("img",{className:"hangman",src:"./static/images/7.png"});case 0:return n.createElement("img",{className:"hangman",src:"./static/images/8.png"})}})(e.remainingAttempts)))})),Y=K,q=s.ZP.div`
    width: 100%;
    background-color: #e7ebf1;
    height: 200px;
