...
// Set page title
$GLOBALS['template_data']['title'] = $page_data['title'] ?? 'Download Instagram Videos';
...
<section class="hero-section">
    <div class="container">
        <div class="text-center">
            <h1 class="hero-title"><?php echo htmlspecialchars($page_data['title'] ?? 'Instagram Video Downloader'); ?></h1>
            <p class="hero-subtitle"><?php echo __('hero_subtitle', 'Download Instagram videos, Reels, Stories & IGTV in HD quality'); ?></p>
        </div>
            ...
            <div class="col-lg-8 col-xl-6">
                <div class="download-container">
                    <div class="mb-4 text-center">
                        <i class="fab fa-instagram" style="font-size: 48px; color: var(--primary-color); margin-bottom: 20px;"></i>
                        <h4 style="color: var(--dark-text); font-weight: 600;"><?php echo __('download.paste_url', 'Paste Instagram Video URL'); ?></h4>
                    </div>
                    ...
                    <div class="input-group mb-3" style="gap: 15px;">
                        <input type="text" 
                               class="url-input" 
                               id="videoUrl" 
                               placeholder="<?php echo __('input_placeholder', 'Paste Instagram URL here...'); ?>">
                    ...
                    <div class="format-tags">
                        ...
                        <span class="format-tag">
                            <i class="fas fa-ban me-1"></i> No Watermark
                        </span>
                        <span class="format-tag">
                    ...
                    <div id="loading" class="text-center mt-4" style="display: none;">
                        <div style="background: #f8f9fa; border-radius: 12px; padding: 30px;">
                            ...
                            <p class="mb-0" style="color: #6c757d; font-weight: 500;">
                                <?php echo __('processing_text', 'Processing your Instagram video...'); ?>
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div style="background: white; border-radius: 16px; padding: 40px; 
                    ...
                    <?php else: ?>
                        <div class="text-center" style="padding: 60px 0; color: var(--gray-text);">
                            <i class="fab fa-instagram" style="font-size: 80px; opacity: 0.3; margin-bottom: 30px;"></i>
...
<section class="py-5" style="background: var(--bg-light);">
    <div class="container">
        <div class="row g-4">
            ...
            $features = [
                [
                    'title' => __('features.watermark.title', 'No Watermark'),
                    'description' => __('features.watermark.desc', 'Download clean videos without Instagram watermarks'),
                    'icon' => 'fas fa-ban'
                ],
                [
                    'title' => __('features.quality.title', 'HD Quality'),
                    'description' => __('features.quality.desc', 'Get videos in highest available quality'),
                    'icon' => 'fas fa-hd-video'
                ],
                [
                    'title' => __('features.speed.title', 'Fast & Free'),
                    'description' => __('features.speed.desc', 'Download instantly without any cost'),
                    'icon' => 'fas fa-bolt'
                ]
            ];
