        ...
        <div class="col-lg-8 col-md-10">
            <div class="error-page text-center">
                ...
                <div class="error-icon mb-4">
                    <i class="fab fa-instagram" style="font-size: 120px; color: var(--primary-color); animation: bounce 2s infinite;"></i>
                </div>
                ...
                <p class="error-message mb-4" style="color: #cccccc; font-size: 18px; line-height: 1.6;">
                    <?php echo __('404.message', 'Oops! The page you\'re looking for seems to have disappeared like a viral Instagram post. Don\'t worry, let\'s get you back on track!'); ?>
                </p>
                ...
                <div class="search-box mb-4">
                    <div class="input-group" style="max-width: 500px; margin: 0 auto;">
                        <input type="text" 
                               ...
                               placeholder="<?php echo __('404.search_placeholder', 'Search for Instagram videos...'); ?>" 
                               id="search404" 
                        ...
                        <div class="col-md-4">
                            <div class="feature-card p-3" style="background: rgba(255,255,255,0.05); border-radius: 15px; border: 1px solid rgba(255,255,255,0.1);">
                                ...
                                <p style="color: #cccccc; font-size: 14px; margin: 0;">
                                    <?php echo __('404.feature_download_desc', 'Download Instagram videos without watermark'); ?>
                                </p>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="feature-card p-3" style="background: rgba(255,255,255,0.05); border-radius: 15px; border: 1px solid rgba(255,255,255,0.1);">
                                ...
                                <p style="color: #cccccc; font-size: 14px; margin: 0;">
                                    <?php echo __('404.feature_audio_desc', 'Extract audio from Instagram videos'); ?>
                                </p>
                            </div>
                        </div>
                        <div class="col-md-4">
