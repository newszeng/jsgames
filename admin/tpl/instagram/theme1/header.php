...
<head>
    <title><?php echo htmlspecialchars($GLOBALS['template_data']['title'] ?? __('hero_title', 'Instagram Video Downloader')); ?></title>
    <meta name="description" content="<?php echo htmlspecialchars($GLOBALS['template_data']['meta_description'] ?? __('meta_description', 'Download Instagram videos, Reels & Stories online for free. Fast Instagram video downloader with no watermark. Save Instagram content in HD quality. Works on all devices.')); ?>" />
    ...
    <meta property="og:title" content="<?php echo htmlspecialchars(__('hero_title', 'Instagram Video Downloader')); ?>">
    <meta property="og:description" content="<?php echo htmlspecialchars(__('meta_description', 'Download Instagram videos, Reels & Stories online for free. Fast Instagram video downloader with no watermark.')); ?>">
    <meta property="og:locale" content="<?php echo $GLOBALS['site_lang']; ?>">
    <meta property="twitter:card" content="summary_large_image">
    <meta property="twitter:title" content="<?php echo htmlspecialchars(__('hero_title', 'Instagram Video Downloader')); ?>">
    <meta property="twitter:description" content="<?php echo htmlspecialchars(__('meta_description', 'Download Instagram videos, Reels & Stories online for free.')); ?>">
...
<body>
    <!-- Header Navigation - InstaDown Exact Structure -->
    <header>
        <nav class="navbar header-nav navbar-expand-lg navbar-light scrolling-navbar">
            <div class="container">
                <a class="navbar-brand" href="<?php echo get_page_url('/'); ?>">
                    <img src="/instagram.png" alt="Instagram" class="d-inline-block align-top" style="height: 32px; width: auto; margin-right: 10px;">
                    <strong><?php echo __('site_name', 'InstaDown'); ?></strong>
                </a>
