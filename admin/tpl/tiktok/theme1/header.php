...
<head>
    <title><?php echo htmlspecialchars($GLOBALS['template_data']['title'] ?? __('hero_title', 'TikTok Video Downloader')); ?></title>
    <meta name="description" content="<?php echo htmlspecialchars($GLOBALS['template_data']['meta_description'] ?? __('meta_description', 'Download TikTok videos without watermark in HD quality. Fast, free, and easy to use TikTok downloader.')); ?>" />
    ...
    <meta property="og:title" content="<?php echo htmlspecialchars(__('hero_title', 'TikTok Video Downloader')); ?>">
    <meta property="og:description" content="<?php echo htmlspecialchars(__('meta_description', 'Download TikTok videos without watermark in HD quality. Fast, free, and easy to use TikTok downloader.')); ?>">
    <meta property="og:locale" content="<?php echo $GLOBALS['site_lang']; ?>">
    <meta property="twitter:card" content="summary_large_image">
    <meta property="twitter:title" content="<?php echo htmlspecialchars(__('hero_title', 'TikTok Video Downloader')); ?>">
    <meta property="twitter:description" content="<?php echo htmlspecialchars(__('meta_description', 'Download TikTok videos without watermark in HD quality.')); ?>">
    <meta name="theme-color" content="#195fd7">
        ...
        <nav class="navbar header-nav navbar-expand-lg navbar-light scrolling-navbar">
            <div class="container">
                <a class="navbar-brand" href="<?php echo get_page_url('/'); ?>">
                    <img src="/tiktok.png" alt="TikTok" class="d-inline-block align-top" style="height: 32px; width: auto; margin-right: 10px;">
                    <strong><?php echo __('site_name', 'SnapTik'); ?></strong>
                </a>
