...
<head>
    <title><?php echo htmlspecialchars($GLOBALS['template_data']['title'] ?? __('hero_title', 'Pinterest Video Downloader')); ?></title>
    <meta name="description" content="<?php echo htmlspecialchars($GLOBALS['template_data']['meta_description'] ?? __('meta_description', 'Download Pinterest videos online for free. Save Pinterest videos and images from any Pin or board in HD quality. The fastest Pinterest downloader with no watermark. Works on all devices.')); ?>" />
    ...
    <meta property="og:title" content="<?php echo htmlspecialchars(__('hero_title', 'Pinterest Video Downloader')); ?>">
    <meta property="og:description" content="<?php echo htmlspecialchars(__('meta_description', 'Download Pinterest videos online for free. Save Pinterest videos and images from any Pin or board in HD quality. The fastest Pinterest downloader with no watermark. Works on all devices.')); ?>">
    <meta property="og:locale" content="<?php echo $GLOBALS['site_lang']; ?>">
    <meta property="twitter:card" content="summary_large_image">
    <meta property="twitter:title" content="<?php echo htmlspecialchars(__('hero_title', 'Pinterest Video Downloader')); ?>">
    <meta property="twitter:description" content="<?php echo htmlspecialchars(__('meta_description', 'Download Pinterest videos online for free. Save Pinterest videos and images from any Pin or board in HD quality.')); ?>">
    ...
    <style>
        .dl-box {
            background: linear-gradient(135deg, #8B1538 0%, #B85450 100%) !important;
        }
    </style>
        ...
        <nav class="navbar header-nav navbar-expand-lg navbar-light scrolling-navbar">
            <div class="container">
                <a class="navbar-brand" href="<?php echo get_page_url('/'); ?>">
                    <img src="/pinterest.png" alt="Pinterest" class="d-inline-block align-top" style="height: 32px; width: auto; margin-right: 10px;">
                    <strong><?php echo __('site_name', 'Pinterest Downloader'); ?></strong>
                </a>
