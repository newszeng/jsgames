...
function generatePrivacyContent() {
    ...
    <p style="color: var(--gray-text);">We collect information you provide directly to us, such as when you use our Pinterest video downloading service.</p>
    
    <h3 style="color: var(--dark-text); margin: 40px 0 20px;">How We Use Your Information</h3>
    <p style="color: var(--gray-text);">We use the information we collect to provide, maintain, and improve our Pinterest downloading services.</p>
...
function generateTermsContent() {
    ...
    <p style="color: var(--gray-text);">By using our Pinterest video downloading service, you agree to be bound by these Terms of Service.</p>
    
    <h3 style="color: var(--dark-text); margin: 40px 0 20px;">Description of Service</h3>
    <p style="color: var(--gray-text);">We provide a free Pinterest video downloading service that allows users to download Pinterest videos and images from Pins and boards.</p>
    
    <h3 style="color: var(--dark-text); margin: 40px 0 20px;">User Responsibilities</h3>
    <p style="color: var(--gray-text);">You are responsible for ensuring that your use of our service complies with applicable laws and Pinterest\'s terms of service.</p>
...
function generateDmcaContent() {
    ...
    <p style="color: var(--gray-text);">We respect the intellectual property rights of others and expect our users to do the same when using our Pinterest downloading service.</p>
...
function generateAboutContent() {
    ...
    <p style="color: var(--gray-text); font-size: 18px; margin-bottom: 30px;">We are a free Pinterest video downloading service that helps users download Pinterest videos and images from Pins and boards in HD quality.</p>
    
    <h3 style="color: var(--dark-text); margin: 40px 0 20px;">Our Mission</h3>
    <p style="color: var(--gray-text);">To provide a fast, free, and easy-to-use Pinterest video downloader that respects user privacy and delivers high-quality downloads of Pins and board content.</p>
    
    <h3 style="color: var(--dark-text); margin: 40px 0 20px;">Features</h3>
    <ul style="color: var(--gray-text); line-height: 1.8;">
        <li>Download Pinterest videos and images</li>
    ...
    <p style="color: var(--gray-text);">We prioritize user experience, privacy, and quality. Our service is designed to be simple yet powerful, giving you access to your favorite Pinterest content from any Pin or board.</p>
    ...
    <div style="text-align: center; margin-top: 40px;">
        <a href="' . get_page_url('/') . '" class="btn" style="background: linear-gradient(45deg, var(--primary-color), var(--accent-color)); 
            ...
            <i class="fab fa-pinterest me-2"></i>Start Downloading Now
        </a>
    </div>';
}
?>