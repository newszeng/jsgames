...
// Set page title
$GLOBALS['template_data']['title'] = $page_data['title'] ?? 'Download Pinterest Videos';
...
<section class="hero-section">
    <div class="container">
        <div class="text-center">
            <h1 class="hero-title"><?php echo htmlspecialchars($page_data['title'] ?? 'Pinterest Video Downloader'); ?></h1>
            <p class="hero-subtitle"><?php echo __('hero_subtitle', 'Download Pinterest videos, images, and Pins in HD quality'); ?></p>
        </div>
            ...
            <div class="col-lg-8 col-xl-6">
                <div class="download-container">
                    <div class="mb-4 text-center">
                        <i class="fab fa-pinterest" style="font-size: 48px; color: #BD081C; margin-bottom: 20px;"></i>
                        <h4 style="color: var(--dark-text); font-weight: 600;"><?php echo __('download.paste_url', 'Paste Pinterest Video URL'); ?></h4>
                    </div>
                    ...
                    <div class="input-group mb-3" style="gap: 15px;">
                        <input type="text" 
                               class="url-input" 
                               id="videoUrl" 
                               placeholder="<?php echo __('input_placeholder', 'Paste Pinterest video or Pin link here'); ?>">
                    ...
                    <div id="loading" class="text-center mt-4" style="display: none;">
                        <div style="background: #f8f9fa; border-radius: 12px; padding: 30px;">
                            ...
                            <p class="mb-0" style="color: #6c757d; font-weight: 500;">
                                <?php echo __('processing_text', 'Processing your Pinterest video...'); ?>
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div style="background: white; border-radius: 16px; padding: 40px; 
                    ...
                    <?php else: ?>
                        <div class="text-center" style="padding: 60px 0; color: var(--gray-text);">
                            <i class="fab fa-pinterest" style="font-size: 80px; opacity: 0.3; margin-bottom: 30px;"></i>
...
<section class="py-5" style="background: var(--bg-light);">
    <div class="container">
        <div class="row g-4">
            ...
            $features = [
                [
                    'title' => __('features.pins.title', 'Download Video Pins'),
                    'description' => __('features.pins.desc', 'Save Pinterest video Pins in high quality'),
                    'icon' => 'fas fa-thumbtack'
                ],
                [
                    'title' => __('features.boards.title', 'From Any Board'),
                    'description' => __('features.boards.desc', 'Download videos from public Pinterest boards'),
                    'icon' => 'fas fa-columns'
                ],
                [
                    'title' => __('features.images.title', 'Images & Videos'),
                    'description' => __('features.images.desc', 'Download both video and image content from Pinterest'),
                    'icon' => 'fas fa-image'
                ]
            ];
